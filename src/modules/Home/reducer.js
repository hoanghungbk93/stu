...
export const addRequirement = (header, params) => async dispatch => {
  ...
  try {
    debugger
    console.log('addRequirement params', params)
    fetch(`https://47783546.ngrok.io/api/stuyc/addyc`, {
      method: 'POST',
...
export const deleteRequirement = (header, requirementId) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://47783546.ngrok.io/api/sturequirement/deleterequirement/?id=${requirementId}`, {
      method: 'DELETE',
    }).then((response) => {
      debugger
      console.log('responseaa', response)
...
export const editRequirement = (header, params) => async dispatch => {
  try {
    debugger
    fetch(`https://47783546.ngrok.io/api/stuyc/updateyc`, {
      method: 'PUT',
      body: JSON.stringify(params),
      headers: {
        "Content-Type": 'application/json'
...
export const getListRequirement = (header, userId) => async dispatch => {
  ...
  try {
    ...
    fetch(`https://47783546.ngrok.io/api/stuyc/getallyc`).then((response) => {
...
export const cancel = (header, params) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://47783546.ngrok.io/api/stuuser/adduser`, {
      method: 'POST',
      body: JSON.stringify(params),
      headers: {
        "Content-Type": 'application/json'

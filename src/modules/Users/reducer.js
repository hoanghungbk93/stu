...
export const addUser = (header, params) => async dispatch => {
  ...
  try {
    fetch(`https://api.stu.vn/api/stuuser/adduser`, {
      method: 'POST',
...
export const deleteUser = (header, userId) => async dispatch => {
  ...
  try {
    fetch(`https://api.stu.vn/api/stuuser/deleteuser/?id=${userId}`,{
      method: 'DELETE',
    }).then((response) => {
      console.log('responseaa', response)
      if(!response.ok) throw new Error(response.status);
...
export const editUser = (header, params) => async dispatch => {
  try {
    fetch(`https://api.stu.vn/api/stuuser/updateuser`, {
      method: 'PUT',
      body: JSON.stringify(params),
      headers: {
        "Content-Type": 'application/json'
...
export const getListUser = (header, userId) => async dispatch => {
  ...
  try {
    ...
    fetch(`https://api.stu.vn/api/stuuser/getalluser`).then((response) => {

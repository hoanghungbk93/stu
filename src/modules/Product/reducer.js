...
export const addProduct = (header, params) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://93696d89.ngrok.io/api/stuvt/addvt`, {
      method: 'POST',
...
export const deleteProduct = (header, ProductId) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://93696d89.ngrok.io/api/stuvt/deletevt/?id=${ProductId}`,{
      method: 'DELETE',
    }).then((response) => {
      debugger
      console.log('responseaa', response)
...
export const editProduct = (header, params) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://93696d89.ngrok.io/api/stuvt/updatevt`, {
      method: 'PUT',
      body: JSON.stringify(params),
      headers: {
        "Content-Type": 'application/json'
...
export const getListProduct = (header, ProductuserId) => async dispatch => {
  try {
    ...
    fetch(`https://93696d89.ngrok.io/api/stuvt/getallvt`).then((response) => {

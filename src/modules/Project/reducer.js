...
export const addProject = (header, params) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://39af1d67.ngrok.io/api/studa/addnewda`, {
      method: 'POST',
...
export const deleteProject = (header, projectId) => async dispatch => {
  ...
  try {
    debugger
    fetch(`https://39af1d67.ngrok.io/api/studa/deleteda/?id=${projectId}`,{
      method: 'DELETE',
    }).then((response) => {
      debugger
      console.log('responseaa', response)
...
export const editProject = (header, params) => async dispatch => {
  try {
    debugger
    fetch(`https://39af1d67.ngrok.io/api/studa/updateda`, {
      method: 'PUT',
      body: JSON.stringify(params),
      headers: {
        "Content-Type": 'application/json'
...
export const getListProject = (header, projectuserId) => async dispatch => {
  try {
    ...
    fetch(`https://39af1d67.ngrok.io/api/studa/getallda`).then((response) => {
